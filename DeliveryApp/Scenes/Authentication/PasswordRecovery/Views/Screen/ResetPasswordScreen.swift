...
class ResetPasswordScreen: UIView {
    ...
    private lazy var newPasswordField: DAFormTextField = {
        let textField = DAFormTextField(placeholder: "New Password", fieldType: "password")
        return textField
    }()
    ...
    let confirmPasswordField = DAFormTextField(placeholder: "Confirm Password", fieldType: "password")
